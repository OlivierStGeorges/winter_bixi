...
def gen_stations_db(df):
    ...
    # Final : conserver l'arrondissement s'il existe
...
# Charger les trajets
df = pd.read_csv("hiver_2023_2024.csv")

stations_db = gen_stations_db(df)

stations_db.to_csv("bd_stations_hiver_2023_2024.csv")

df = pd.read_csv("hiver_2024_2025.csv")

stations_db = gen_stations_db(df)

stations_db.to_csv("bd_stations_hiver_2024_2025.csv")
